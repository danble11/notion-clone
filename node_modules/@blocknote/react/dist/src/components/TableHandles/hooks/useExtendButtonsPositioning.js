...
function useExtendButtonPosition(orientation, show, referencePosTable) {
        ...
        middleware: [
            size({
                apply({ rects, elements }) {
                    Object.assign(elements.floating.style, orientation === "addOrRemoveColumns"
                        ? {
...
export function useExtendButtonsPositioning(showAddOrRemoveColumnsButton, showAddOrRemoveRowsButton, referencePosTable) {
...
//# sourceMappingURL=useExtendButtonsPositioning.js.map