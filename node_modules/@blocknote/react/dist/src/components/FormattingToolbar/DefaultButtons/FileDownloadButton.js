...
export const FileDownloadButton = () => {
    ...
    return (_jsx(Components.FormattingToolbar.Button, { className: "bn-button", label: dict.formatting_toolbar.file_download.tooltip[fileBlock.type] ||
            dict.formatting_toolbar.file_download.tooltip["file"], mainTooltip: dict.formatting_toolbar.file_download.tooltip[fileBlock.type] ||
            dict.formatting_toolbar.file_download.tooltip["file"], icon: _jsx(RiDownload2Fill, {}), onClick: onClick }));
};
//# sourceMappingURL=FileDownloadButton.js.map