...
function checkBasicTextStyleInSchema(style, editor) {
...
export const BasicTextStyleButton = (props) => {
    const dict = useDictionary();
    const Components = useComponentsContext();
    const editor = useBlockNoteEditor();
    const basicTextStyleInSchema = checkBasicTextStyleInSchema(props.basicTextStyle, editor);
    const selectedBlocks = useSelectedBlocks(editor);
    const [active, setActive] = useState(props.basicTextStyle in editor.getActiveStyles());
    ...
    const Icon = icons[props.basicTextStyle]; // TODO
    return (_jsx(Components.FormattingToolbar.Button, { className: "bn-button", "data-test": props.basicTextStyle, onClick: () => toggleStyle(props.basicTextStyle), isSelected: active, label: dict.formatting_toolbar[props.basicTextStyle].tooltip, mainTooltip: dict.formatting_toolbar[props.basicTextStyle].tooltip, secondaryTooltip: formatKeyboardShortcut(dict.formatting_toolbar[props.basicTextStyle].secondary_tooltip, dict.generic.ctrl_shortcut), icon: _jsx(Icon, {}) }));
};
//# sourceMappingURL=BasicTextStyleButton.js.map