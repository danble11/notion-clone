...
export function useCloseSuggestionMenuNoItems(items, usedQuery, closeMenu, invalidQueries = 3) {
    ...
    useEffect(() => {
        ...
        else if (usedQuery.length - lastUsefulQueryLength.current >
            invalidQueries) {
            closeMenu();
        }
    }, [closeMenu, invalidQueries, items.length, usedQuery]);
}
//# sourceMappingURL=useCloseSuggestionMenuNoItems.js.map