...
export const usePrefersColorScheme = () => {
    ...
    const [preferredColorSchema, setPreferredColorSchema] = useState(isDark ? "dark" : isLight ? "light" : "no-preference");
    useEffect(() => {
        if (isDark) {
    ...
    useEffect(() => {
        if (typeof darkQuery?.addEventListener === "function") {
            ...
            const listener = () => setPreferredColorSchema(darkQuery.matches
                ? "dark"
                : lightQuery.matches
                    ? "light"
                    : "no-preference");
