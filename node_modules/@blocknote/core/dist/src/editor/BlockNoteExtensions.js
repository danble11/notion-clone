...
export const getBlockNoteExtensions = (opts) => {
    ...
    ret["formattingToolbar"] = new FormattingToolbarProsemirrorPlugin(opts.editor);
    ...
    ret["filePanel"] = new FilePanelProsemirrorPlugin(opts.editor);
    ...
    if (opts.tableHandles) {
        ret["tableHandles"] = new TableHandlesProsemirrorPlugin(opts.editor);
    }
    ret["dropCursor"] = {
    ...
    const disableExtensions = opts.disableExtensions || [];
 ...
 * Get all the Tiptap extensions BlockNote is configured with by default
 */
const getTipTapExtensions = (opts) => {
    const tiptapExtensions = [
        ...
        ...Object.values(opts.blockSpecs).flatMap((blockSpec) => {
            return [
                ...
                ...(blockSpec.implementation.requiredExtensions || []).map((ext) => ext.configure({
                    editor: opts.editor,
                    domAttributes: opts.domAttributes,
                })),
    ...
    if (opts.collaboration) {
        tiptapExtensions.push(Collaboration.configure({
        ...
        if (opts.collaboration.provider?.awareness) {
            ...
            tiptapExtensions.push(CollaborationCursor.configure({
...
//# sourceMappingURL=BlockNoteExtensions.js.map