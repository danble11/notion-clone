...
import { getBlockInfo, getNearestBlockPos, } from "../api/getBlockInfoFromPos.js";
...
it("immediately replaces doc", async () => {
    const editor = BlockNoteEditor.create();
    const blocks = await editor.tryParseMarkdownToBlocks("This is a normal text\n\n# And this is a large heading");
...
//# sourceMappingURL=BlockNoteEditor.test.js.map