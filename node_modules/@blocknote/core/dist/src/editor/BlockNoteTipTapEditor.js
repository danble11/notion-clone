...
export class BlockNoteTipTapEditor extends TiptapEditor {
    _state;
    _creating = false;
    static create = (options, styleSchema) => {
    ...
    constructor(options, styleSchema) {
    ...
    createViewAlternative() {
        ...
        queueMicrotask(() => {
            ...
            this.view = new EditorView({ mount: this.options.element }, // use mount option so that we reuse the existing element instead of creating a new one
            {
...
BlockNoteTipTapEditor.prototype.createView = function () {
    // no-op
...
//# sourceMappingURL=BlockNoteTipTapEditor.js.map