...
describe("Test replaceBlocks", () => {
    ...
    it("Remove multiple consecutive blocks", () => {
        replaceBlocks(getEditor(), ["paragraph-0", "paragraph-1", "paragraph-with-children"], []);
        expect(getEditor().document).toMatchSnapshot();
    });
    it("Remove multiple non-consecutive blocks", () => {
        replaceBlocks(getEditor(), ["paragraph-0", "table-0", "heading-with-everything"], []);
        expect(getEditor().document).toMatchSnapshot();
    });
    ...
    it("Replace multiple consecutive blocks with single basic", () => {
        replaceBlocks(getEditor(), ["paragraph-0", "paragraph-1", "paragraph-with-children"], [{ type: "paragraph" }]);
        expect(getEditor().document).toMatchSnapshot();
    });
    it("Replace multiple non-consecutive blocks with single basic", () => {
        replaceBlocks(getEditor(), ["paragraph-0", "table-0", "heading-with-everything"], [{ type: "paragraph" }]);
        expect(getEditor().document).toMatchSnapshot();
    });
...
//# sourceMappingURL=replaceBlocks.test.js.map