...
describe("Test ProseMirror selection clipboard HTML", () => {
    ...
    async function testSelection(testCase) {
        editor.dispatch(editor._tiptapEditor.state.tr.setSelection(testCase.createSelection(editor._tiptapEditor.view.state.doc)));
        const { clipboardHTML, externalHTML } = selectedFragmentToHTML(editor._tiptapEditor.view, editor);
        expect(externalHTML).toMatchFileSnapshot(`./__snapshots__/${testCase.testName}.html`);
        const originalDocument = editor.document;
        doPaste(editor._tiptapEditor.view, "text", clipboardHTML, false, new ClipboardEvent("paste"));
