 ...
 */
export function fragmentToBlocks(fragment, schema) {
    ...
    fragment.descendants((node) => {
        ...
        if (node.type.name === "columnList" && node.childCount === 1) {
            ...
            node.firstChild?.forEach((child) => {
                blocks.push(nodeToBlock(child, schema.blockSchema, schema.inlineContentSchema, schema.styleSchema));
            });
            return false;
        }
...
//# sourceMappingURL=fragmentToBlocks.js.map