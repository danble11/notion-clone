...
function range(start, end) {
  ...
  return Array.from({ length }, (_2, index2) => index2 + start);
}
var DOTS = "dots";
...
function useShallowCompare(dependencies) {
  ...
  const updateRef = (0, import_react35.useRef)(0);
...
function useHover2() {
  ...
  const onMouseEnter = (0, import_react44.useCallback)(() => setHovered(true), []);
  const onMouseLeave = (0, import_react44.useCallback)(() => setHovered(false), []);
...
var _Box = (0, import_react105.forwardRef)(
  ({
    ...
    return (0, import_jsx_runtime32.jsxs)(import_jsx_runtime32.Fragment, { children: [
      ...
      typeof renderRoot === "function" ? renderRoot(props) : (0, import_jsx_runtime32.jsx)(Element, { ...props })
    ] });
  }
);
...
var Thumb = (0, import_react123.forwardRef)((props, forwardedRef) => {
  ...
  const removeUnlinkedScrollListenerRef = (0, import_react123.useRef)(void 0);
...
var varsResolver = createVarsResolver(
  (_2, { scrollbarSize, overscrollBehavior }) => ({
    root: {
...
var ScrollArea = factory((_props, ref) => {
  ...
  const [verticalThumbVisible, setVerticalThumbVisible] = (0, import_react125.useState)(false);
  const [horizontalThumbVisible, setHorizontalThumbVisible] = (0, import_react125.useState)(false);
  ...
  const localViewportRef = (0, import_react125.useRef)(null);
...
var Portal = factory((props, ref) => {
  ...
  const nodeRef = (0, import_react132.useRef)(null);
  useIsomorphicEffect(() => {
    setMounted(true);
...
function FocusTrap({
  ...
  return (0, import_react137.cloneElement)(children, { [refProp]: ref });
}
...
// node_modules/@mantine/core/esm/components/Loader/loaders/Bars.mjs
var Bars = (0, import_react147.forwardRef)(({ className, ...others }, ref) => (0, import_jsx_runtime66.jsxs)(Box, { component: "span", className: clsx_default(classes7.barsLoader, className), ...others, ref, children: [
...
var Dots = (0, import_react148.forwardRef)(({ className, ...others }, ref) => (0, import_jsx_runtime67.jsxs)(Box, { component: "span", className: clsx_default(classes7.dotsLoader, className), ...others, ref, children: [
...
var Oval = (0, import_react149.forwardRef)(({ className, ...others }, ref) => (0, import_jsx_runtime68.jsx)(Box, { component: "span", className: clsx_default(classes7.ovalLoader, className), ...others, ref }));
...
var InputWrapper = factory((_props, ref) => {
  ...
  const _input = (0, import_jsx_runtime92.jsx)(import_react177.Fragment, { children: inputContainer(children) }, "input");
...
var AngleSlider = factory((_props, ref) => {
  ...
  const marksItems = marks == null ? void 0 : marks.map((mark, index2) => (0, import_react195.createElement)(
    "div",
    {
          ...
          Box,
          {
            ...
            children: [
              ...
              (0, import_jsx_runtime144.jsxs)("div", { ...getStyles("labelWrapper"), "data-disabled": disabled || void 0, children: [
                ...
                error && typeof error !== "boolean" && (0, import_jsx_runtime144.jsx)(Input.Error, { size: size2, __inheritStyles: false, ...getStyles("error"), children: error })
              ] })
            ]
          }
        )
...
var Avatar = polymorphicFactory((_props, ref) => {
  ...
  return (0, import_jsx_runtime156.jsx)(
    Box,
    {
      ...
      ref,
      ...others,
      children: error ? (0, import_jsx_runtime156.jsx)("span", { ...getStyles("placeholder"), title: alt, children: children || typeof name === "string" && getInitials(name) || (0, import_jsx_runtime156.jsx)(AvatarPlaceholderIcon, {}) }) : (0, import_jsx_runtime156.jsx)(
        "img",
        {
          ...imageProps,
          ...getStyles("image"),
...
var Breadcrumbs = factory((_props, ref) => {
  ...
  const items = import_react247.Children.toArray(children).reduce((acc, child, index2, array) => {
    var _a;
    const item = isElement(child) ? (0, import_react247.cloneElement)(child, {
      ...
      key: index2
    }) : (0, import_react247.createElement)("div", { ...getStyles("breadcrumb"), key: index2 }, child);
    acc.push(item);
    if (index2 !== array.length - 1) {
      acc.push(
        (0, import_react247.createElement)(Box, { ...getStyles("separator"), key: `separator-${index2}` }, separator)
      );
    }
    return acc;
  }, []);
...
var Thumb2 = (0, import_react262.forwardRef)(({ position, ...others }, ref) => (0, import_jsx_runtime175.jsx)(
  Box,
  {
    ref,
    __vars: {
...
var ColorSlider = factory((_props, ref) => {
  ...
  const layers = overlays.map((overlay, index2) => (0, import_react263.createElement)("div", { ...getStyles("sliderOverlay"), style: overlay, key: index2 }));
...
var Swatches = (0, import_react267.forwardRef)(
  ({
    ...
    const colors = data.map((color, index2) => (0, import_react267.createElement)(
      ColorSwatch,
      {
...
var ColorPicker = factory((_props, ref) => {
  ...
  const formatRef = (0, import_react268.useRef)(format2);
...
function useDelayedHover({ open, close, openDelay, closeDelay }) {
  const openTimeout = (0, import_react288.useRef)(-1);
  const closeTimeout = (0, import_react288.useRef)(-1);
  const clearTimeouts = () => {
  ...
  (0, import_react288.useEffect)(() => clearTimeouts, []);
...
var HoverCardTarget = (0, import_react299.forwardRef)((props, ref) => {
  ...
  return (0, import_jsx_runtime211.jsx)(Popover.Target, { refProp, ref, ...others, children: (0, import_react299.cloneElement)(
    children,
...
var Image = polymorphicFactory((_props, ref) => {
  ...
  const [error, setError] = (0, import_react302.useState)(!src);
  (0, import_react302.useEffect)(() => setError(!src), [src]);
  const getStyles = useStyles({
    name: "Image",
    classes: classes49,
    props,
...
var MenuTarget = (0, import_react317.forwardRef)((props, ref) => {
  ...
  return (0, import_jsx_runtime228.jsx)(Popover.Target, { refProp, popupType: "menu", ref, ...others, children: (0, import_react317.cloneElement)(children, {
    onClick,
    onMouseEnter,
    onMouseLeave,
...
var NativeSelect = factory((props, ref) => {
  ...
  const options = getParsedComboboxData(data).map((item, index2) => (0, import_jsx_runtime249.jsx)(NativeSelectOption, { data: item }, index2));
...
function NumberFormatBase(props) {
  ...
  var useIsomorphicLayoutEffect = typeof window !== "undefined" ? import_react342.useLayoutEffect : import_react342.useEffect;
...
function PaginationItems({ dotsIcon }) {
  ...
  const items = ctx.range.map((page, index2) => {
    var _a, _b, _c;
    if (page === "dots") {
      return (0, import_jsx_runtime260.jsx)(PaginationDots, { icon: dotsIcon }, index2);
    }
  ...
  return (0, import_jsx_runtime265.jsxs)(import_jsx_runtime265.Fragment, { children: [
    (0, import_jsx_runtime265.jsx)(
      Group,
      {
        ...
        __size: size2,
        dir: "ltr",
        children: _value.map((char, index2) => (0, import_react352.createElement)(
          Input,
          {
            component: "input",
            ...getStyles("pinInput", {
...
var Rating = factory((_props, ref) => {
  ...
  const items = Array(_count).fill(0).map((_2, index2) => {
...
var RingProgress = factory((_props, ref) => {
  ...
  const curves = getCurves({
    ...
    rootColor
  }).map(({ data, sum, root, lineRoundCaps, offset: offset2 }, index2) => (0, import_react379.createElement)(
    Curve,
    {
      ...data,
      key: index2,
...
var SegmentedControl = factory((_props, ref) => {
  ...
  const [key, setKey] = (0, import_react380.useState)(randomId());
...
function Marks({ marks, min, max, disabled, value, offset: offset2, inverted }) {
  ...
  const items = marks.map((mark, index2) => (0, import_react389.createElement)(
    Box,
    {
...
var Slider = factory((_props, ref) => {
  ...
  const onChangeEndRef = (0, import_react391.useRef)(onChangeEnd);
  ...
  const handleScrubEnd = (0, import_react391.useCallback)(() => {
  ...
  const callOnChangeEnd = (0, import_react391.useCallback)(
    (value2) => {
      if (!disabled && onChangeEndRef.current) {
...
var RangeSlider = factory((_props, ref) => {
  ...
  const setRangedValue = (val, index2, triggerChangeEnd) => {
    ...
    if (restrictToMarks && marks) {
      ...
      const current = clone[index2];
      clone[index2] = closest;
      const otherIndex = index2 === 0 ? 1 : 0;
...
var getStepFragment = (Fragment26, step) => {
  if (typeof Fragment26 === "function") {
    return (0, import_jsx_runtime305.jsx)(Fragment26, { step: step || 0 });
  }
  return Fragment26;
};
var defaultProps167 = {
...
function TableDataRenderer({ data }) {
  return (0, import_jsx_runtime311.jsxs)(import_jsx_runtime311.Fragment, { children: [
    ...
    data.head && (0, import_jsx_runtime311.jsx)(TableThead, { children: (0, import_jsx_runtime311.jsx)(TableTr, { children: data.head.map((item, index2) => (0, import_jsx_runtime311.jsx)(TableTh, { children: item }, index2)) }) }),
    data.body && (0, import_jsx_runtime311.jsx)(TableTbody, { children: data.body.map((row, rowIndex) => (0, import_jsx_runtime311.jsx)(TableTr, { children: row.map((item, index2) => (0, import_jsx_runtime311.jsx)(TableTd, { children: item }, index2)) }, rowIndex)) }),
    data.foot && (0, import_jsx_runtime311.jsx)(TableTfoot, { children: (0, import_jsx_runtime311.jsx)(TableTr, { children: data.foot.map((item, index2) => (0, import_jsx_runtime311.jsx)(TableTh, { children: item }, index2)) }) })
  ] });
}
...
var TableOfContents = factory((_props, ref) => {
  ...
  const controls = headingsData.map((data, index2) => {
    const controlProps = getControlProps == null ? void 0 : getControlProps({
      active: index2 === spy.active,
      data: {
        ...data,
    ...
    return (0, import_jsx_runtime314.jsx)(
      UnstyledButton,
      {
        ...
        "data-active": index2 === spy.active || void 0,
        variant,
        ...controlProps,
        ...getStyles("control", {
...
var TagsInput = factory((_props, ref) => {
  ...
  const values2 = _value.map((item, index2) => (0, import_jsx_runtime321.jsx)(
    Pill,
    {
...
var Tree = factory((_props, ref) => {
  ...
  const nodes = data.map((node, index2) => (0, import_jsx_runtime332.jsx)(
    TreeNode,
    {
      node,
      getStyles,
...
var I = (0, import_react428.forwardRef)(
  (e, n) => {
    const {
      className: t,
      children: o,
    ...
    xc(p, false);
    const [C, y] = (0, import_react428.useState)(false), k = o ? (0, import_jsx_runtime334.jsx)(
      Button,
      {
        "aria-label": g,
        className: t,
...
var De = (0, import_react428.forwardRef)((e, n) => {
  const {
    className: t,
    text: o,
    icon: r,
  ...
  xc(g, false);
  const [h, p] = (0, import_react428.useState)(false), C = (0, import_jsx_runtime334.jsxs)(
    Chip,
    {
      className: t,
      checked: i === true,
  ...
  return !l || h ? C : (0, import_jsx_runtime334.jsx)(
    Tooltip,
    {
      refProp: "rootRef",
      withinPortal: false,
...
var Le = (0, import_react428.forwardRef)((e, n) => {
  const { className: t, children: o, ...r } = e;
  return xc(r), (0, import_jsx_runtime334.jsx)(Group, { className: t, ref: n, children: o });
});
var Be = (0, import_react428.forwardRef)((e, n) => {
  const {
    className: t,
    children: o,
    headerText: r,
  ...
  xc(c, false);
  const g = (0, import_react428.useRef)(null);
  return (0, import_react428.useEffect)(() => {
    var h;
...
var Ee = (0, import_react428.forwardRef)((e, n) => {
  const { className: t, children: o, ...r } = e;
  return xc(r, false), (0, import_jsx_runtime334.jsx)(Card.Section, { className: t, ref: n, children: o });
});
var ze = (0, import_react428.forwardRef)((e, n) => {
  const { className: t, children: o, ...r } = e;
  return xc(r, false), (0, import_jsx_runtime334.jsx)(
    Divider,
    {
      className: t,
...
var je = (0, import_react428.forwardRef)((e, n) => {
  const { authorInfo: t, timeString: o, edited: r, ...i } = e;
  return xc(i, false), t === "loading" ? (0, import_jsx_runtime334.jsxs)(Group, { children: [
...
var $e = (0, import_react428.forwardRef)((e, n) => {
  const {
    className: t,
    showActions: o,
    authorInfo: r,
    ...
    children: u,
    ...c
  } = e, { hovered: g, ref: h } = useHover2(), { focused: p, ref: C } = useFocusWithin(), y = Do([n, h]);
  return xc(c, false), (0, import_jsx_runtime334.jsxs)(Group, { pos: "relative", ref: y, className: t, children: [
...
var Ae = (0, import_react428.forwardRef)((e, n) => {
  const { className: t, autoFocus: o, onFocus: r, onBlur: i, editor: l, editable: a, ...u } = e;
  return xc(u, false), (0, import_jsx_runtime334.jsx)(
    Ft,
    {
      autoFocus: o,
      className: t,
...
var Ve = (0, import_react428.forwardRef)((e, n) => {
  const {
    className: t,
    name: o,
    label: r,
  ...
  return xc(x), (0, import_jsx_runtime334.jsx)(
    TextInput,
    {
      size: "xs",
      className: Z(
...
var H = import_react428.default.createContext && import_react428.default.createContext(oe);
...
function O2(e) {
  for (var n = 1; n < arguments.length; n++) {
    ...
    n % 2 ? K(Object(t), true).forEach(function(o) {
      Ue(e, o, t[o]);
...
function re(e) {
  return e && e.map((n, t) => import_react428.default.createElement(n.tag, O2({
    key: t
  }, n.attr), re(n.child)));
}
function se(e) {
  return (n) => import_react428.default.createElement(Ze, F({
    attr: O2({}, e.attr)
  }, n), re(e.child));
}
function Ze(e) {
  var n = (t) => {
    ...
    return t.className && (u = t.className), e.className && (u = (u ? u + " " : "") + e.className), import_react428.default.createElement("svg", F({
      stroke: "currentColor",
      fill: "currentColor",
      strokeWidth: "0"
    }, t.attr, o, l, {
      ...
      width: a,
      xmlns: "http://www.w3.org/2000/svg"
    }), i && import_react428.default.createElement("title", null, i), e.children);
  };
  return H !== void 0 ? import_react428.default.createElement(H.Consumer, null, (t) => n(t)) : n(oe);
}
function Je(e) {
...
var ie = (0, import_react428.createContext)(void 0);
var Xe = (0, import_react428.forwardRef)((e, n) => {
  const {
    children: t,
    onOpenChange: o,
    position: r,
  ...
  xc(l);
  const [a, u] = (0, import_react428.useState)(false), c = (0, import_react428.useRef)(null), g = (0, import_react428.useRef)(), h = (0, import_react428.useCallback)(() => {
    g.current && clearTimeout(g.current), g.current = setTimeout(() => {
      u(false);
    }, 250);
  }, []), p = (0, import_react428.useCallback)(() => {
...
var Ye = (e) => {
  ...
  return xc(i), r ? (0, import_jsx_runtime334.jsx)(Xe, { ...e }) : (0, import_jsx_runtime334.jsx)(
    Menu,
    {
      withinPortal: false,
      middlewares: { flip: true, shift: true, inline: false, size: true },
...
var et = (0, import_react428.forwardRef)((e, n) => {
  const { className: t, children: o, icon: r, checked: i, subTrigger: l, onClick: a, ...u } = e;
  return xc(u, false), l ? (0, import_jsx_runtime334.jsxs)(
    "div",
    {
      onClick: (c) => {
...
var tt = (e) => {
  ...
  return xc(o), (0, import_jsx_runtime334.jsx)(Menu.Target, { children: n });
};
var nt = (0, import_react428.forwardRef)((e, n) => {
  const {
    className: t,
    children: o,
    sub: r,
  ...
  xc(i);
  const l = (0, import_react428.useContext)(ie);
  return (0, import_jsx_runtime334.jsx)(
    Menu.Dropdown,
    {
      className: t,
...
var ot = (0, import_react428.forwardRef)((e, n) => {
  const { className: t, ...o } = e;
  return xc(o), (0, import_jsx_runtime334.jsx)(Menu.Divider, { className: t, ref: n });
});
var rt = (0, import_react428.forwardRef)((e, n) => {
  const { className: t, children: o, ...r } = e;
  return xc(r), (0, import_jsx_runtime334.jsx)(Menu.Label, { className: t, ref: n, children: o });
});
var st = (0, import_react428.forwardRef)((e, n) => {
  const {
    className: t,
    children: o,
    icon: r,
  ...
  return xc(g, false), r ? (0, import_jsx_runtime334.jsx)(
    ActionIcon,
    {
      size: 24,
      className: t,
...
var it = (0, import_react428.forwardRef)((e, n) => {
  const {
    className: t,
    tabs: o,
    defaultOpenTab: r,
  ...
  return xc(u), (0, import_jsx_runtime334.jsx)(Group, { className: t, ref: n, children: (0, import_jsx_runtime334.jsxs)(
    Tabs,
    {
      value: i,
      defaultValue: r,
...
var at = (0, import_react428.forwardRef)((e, n) => {
  const { className: t, children: o, onClick: r, label: i, ...l } = e;
  return xc(l), (0, import_jsx_runtime334.jsx)(
    Button,
    {
      size: "xs",
      "aria-label": i,
...
var lt = (0, import_react428.forwardRef)((e, n) => {
  const { className: t, accept: o, value: r, placeholder: i, onChange: l, ...a } = e;
  return xc(a), (0, import_jsx_runtime334.jsx)(
    FileInput,
    {
      size: "xs",
      className: t,
...
var ct = (0, import_react428.forwardRef)((e, n) => {
  const { className: t, children: o, ...r } = e;
  return xc(r), (0, import_jsx_runtime334.jsx)("div", { className: t, ref: n, children: o });
});
var ut = (0, import_react428.forwardRef)((e, n) => {
...
var dt = (e) => {
  ...
  return xc(r), (0, import_jsx_runtime334.jsx)(Popover, { withinPortal: false, opened: n, position: t, children: o });
};
var mt = (e) => {
  const { children: n, ...t } = e;
  return xc(t), (0, import_jsx_runtime334.jsx)(PopoverTarget, { children: n });
};
var ft = (0, import_react428.forwardRef)((e, n) => {
  const {
    className: t,
    children: o,
    variant: r,
  ...
  return xc(i), (0, import_jsx_runtime334.jsx)(PopoverDropdown, { className: t, ref: n, children: o });
});
var gt = (0, import_react428.forwardRef)((e, n) => {
  const { className: t, children: o, ...r } = e;
  return xc(r, false), (0, import_jsx_runtime334.jsx)(
    Group,
    {
...
var ht = (0, import_react428.forwardRef)((e, n) => {
  const {
    className: t,
    children: o,
    icon: r,
...
var bt = (0, import_react428.forwardRef)((e, n) => {
  const { className: t, children: o, id: r, ...i } = e;
  return xc(i), (0, import_jsx_runtime334.jsx)(
    Stack,
    {
      gap: 0,
      className: t,
...
var pt = (0, import_react428.forwardRef)((e, n) => {
  const { className: t, children: o, ...r } = e;
  return xc(r), (0, import_jsx_runtime334.jsx)(Group, { className: t, ref: n, children: (0, import_jsx_runtime334.jsx)(Group, { className: "bn-mt-suggestion-menu-item-title", children: o }) });
});
var vt = (0, import_react428.forwardRef)((e, n) => {
  const { className: t, isSelected: o, onClick: r, item: i, id: l, ...a } = e;
  xc(a);
  const u = (0, import_react428.useRef)(null);
  return (0, import_react428.useEffect)(() => {
    if (!u.current || !o)
      return;
    const c = nl(
...
var St2 = (0, import_react428.forwardRef)((e, n) => {
  const { className: t, children: o, ...r } = e;
  return xc(r), (0, import_jsx_runtime334.jsx)(Group, { className: t, ref: n, children: o });
});
var yt = (0, import_react428.forwardRef)((e, n) => {
  const { className: t, ...o } = e;
  return xc(o), (0, import_jsx_runtime334.jsx)(Loader, { className: t, type: "dots", size: 16, ref: n });
});
var xt = (0, import_react428.forwardRef)((e, n) => {
...
var wt = (0, import_react428.forwardRef)((e, n) => {
  const { className: t, isSelected: o, onClick: r, item: i, id: l, ...a } = e;
  xc(a);
  const u = (0, import_react428.useRef)(null);
  return (0, import_react428.useEffect)(() => {
...
var Tt = (0, import_react428.forwardRef)((e, n) => {
  const {
    className: t,
    children: o,
...
var Nt = (0, import_react428.forwardRef)((e, n) => {
  ...
  return xc(l, false), (0, import_jsx_runtime334.jsx)(
    Button,
    {
      className: o,
      ref: n,
...
var kt = (0, import_react428.forwardRef)((e, n) => {
  const {
    className: t,
    children: o,
    draggable: r,
  ...
  return xc(c, false), (0, import_jsx_runtime334.jsx)(
    Button,
    {
      className: t,
      ref: n,
...
var D = (0, import_react428.forwardRef)(
  (e, n) => {
    const {
      className: t,
      children: o,
...
var L = (0, import_react428.forwardRef)((e, n) => {
...
var Ft = (e) => {
  const { className: n, theme: t, ...o } = e, r = O(), i = Qr(), l = (r == null ? void 0 : r.colorSchemePreference) || i, a = (0, import_react428.useCallback)(
    (c) => {
